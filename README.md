...
## Environments
- Preview: https://main--fireflyug--jmoynihanrp.aem.page/
- Live: https://main--fireflyug--jmoynihanrp.aem.live/
...
1. Open the `fireflyug` directory in your favorite IDE and start coding :)
